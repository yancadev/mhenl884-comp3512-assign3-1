  <div class="mdl-layout__drawer mdl-color--blue-grey-800 mdl-color-text--blue-grey-50">
    ...
    <nav class="mdl-navigation mdl-color-text--blue-grey-300">
        ...
        <a class="mdl-navigation__link mdl-color-text--blue-grey-300" name = "page" href="browse-employees.php"><i class="material-icons" role="presentation">people</i> Employees</a>
